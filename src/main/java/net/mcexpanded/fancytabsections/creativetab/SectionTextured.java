...
public class SectionTextured implements Section
{
     ...
     */
    @Deprecated(forRemoval = true, since = "4.0")
    public SectionTextured(Identifier id, Component title, Identifier texture, int textColor, ConglomerateOfItems items)
    {
    ...
    {
        return new SectionTextured(id, title, Identifier.fromNamespaceAndPath(id.getNamespace(),
     ...
     */
    @Deprecated(forRemoval = true, since = "4.0")
    public SectionTextured(Identifier id, Component title, Identifier texture, int textColor, List<Item> items)
    {
