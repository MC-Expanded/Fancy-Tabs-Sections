...
public final class IndexPanel
{
    ...
    private static void drawRaisedBox(GuiGraphicsExtractor g, int x, int y, int w, int h)
    {
    ...
    private static void drawSunkenSlot(GuiGraphicsExtractor g, int x, int y, int w, int h)
    {
